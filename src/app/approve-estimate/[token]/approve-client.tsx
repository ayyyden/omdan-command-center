...
type UIState = "idle" | "loading" | "approved" | "declined" | "error"

export function ApproveClient({ token, initialStatus, approvedAt }: Props) {
  ...
  if (state === "approved") {
    return (
      <div className="flex flex-col items-center gap-4 py-10 text-center">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Estimate Approved</h2>
          <p className="text-gray-500 text-sm mt-1 max-w-xs mx-auto">
            Thank you! Your approval has been recorded. We'll be in touch soon.
          </p>
        </div>
        {approvedAt && (
  ...
  if (state === "declined") {
    return (
      <div className="flex flex-col items-center gap-4 py-10 text-center">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Estimate Declined</h2>
          <p className="text-gray-500 text-sm mt-1 max-w-xs mx-auto">
            We've received your response. Feel free to contact us if you have any questions.
          </p>
        </div>
      </div>
    )
